...
public class FairnessChecker {
    ...
    public void addCurrentThread() {
    	...
    	synchronized(this){
    		mFairnessQueue.add(Thread.currentThread().getId());
    	}
    }
    ...
    public void removeCurrentThread() {
        ...
        // TODO -- you fill in here.
    	synchronized(this){
    		mFairnessQueue.remove(Thread.currentThread().getId());
    	}
    }
    ...
    public boolean isFifoOrder() {
        ...
        // TODO -- you fill in here.
    	synchronized(this){
    		return mFairnessQueue.remove(0).equals(Thread.currentThread().getId());
    	}
    }
