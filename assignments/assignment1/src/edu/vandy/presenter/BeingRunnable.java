...
public class BeingRunnable
    ...
    public void run() {
        ...
        for (;
            ...
            try {
                ...
                // Get a Palantir - this call can block if
                // there are no available Palantiri.
                palantir =
    ...
    private boolean incrementGazingCountAndCheck(Palantir palantir) {
        // @@ TODO - You fill in here. (Graduate students)
	    	if(mPresenter.mGazingThreads.get()>Options.instance().numberOfPalantiri()){
	    		mPresenter.mView.get().threadShutdown(mIndex);
	    		mPresenter.mGazingThreads.getAndIncrement();
	    		return false;
	    	}	else
	    	return true;
    }
    ...
    private void decrementGazingCount() {
        // @@ TODO - You fill in here. (Graduate students)
    		mPresenter.mGazingThreads.getAndDecrement();
    }
}
