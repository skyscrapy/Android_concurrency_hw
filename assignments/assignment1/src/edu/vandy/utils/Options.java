...
public class Options {
    ...
    /** 
     * Type of ISemaphore implementation (e.g., JavaSemaphore
     * vs. SimpleSemaphore).
     */
    private String mSemaphore = "java";
    ...
    /**
     * Make the designated type of ISemaphore.
     */
    public ISemaphore makeSemaphore(int size) {
        switch (mSemaphore.toLowerCase(Locale.ENGLISH)) {
        case "java":
            return new JavaSemaphore(size, 
                                     true);
        case "simple":
