    ...
    private final PalantiriManager.Stub mPalantiriLeasePoolImpl =
    	...
    	new PalantiriManager.Stub() {
            ...
            public Palantir acquire(long leaseDurationInMillis,
            	...
            	return mPalantiriLeasePool.acquire(leaseDurationInMillis, leaseCallback);
            }
            ...
            public void release(Palantir palantir) {
                // TODO - You fill in here.
            	mPalantiriLeasePool.release(palantir);
            }
            ...
            public long remainingTime(Palantir palantir) {
                // TODO - You fill in here.
            	return mPalantiriLeasePool.mPalantiriMap.get(palantir).remainingTime();
            }
        };
}
